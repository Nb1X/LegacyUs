...
| Platform | ✅ / 🟡 / 🟠 / 🔴 |
|------------|------------|
| Android | ✅ (may have bugs) |
| Windows | ✅ (recommended) |
| Linux | 🟡 (Working on it) |
| macOS | 🟠 (Wine is required) |
| iOS / iPadOS | 🔴 |
| Other | 🔴 |

⚠️ If you want to play Legacy Us on Windows/Linux/macOS, you need a Steam (not Epic/itch.io/MS Store) licence of the game.
